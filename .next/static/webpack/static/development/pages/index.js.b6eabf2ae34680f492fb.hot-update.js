...
function (_React$Component) {
  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "firstDD", function (event, _ref) {
      ...
      if ({
        ...
        axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("https://api.exchangeratesapi.io/latest?symbols=".concat(secondCurr, "&base=").concat(value)).then(function (res) {
          console.log("res ", res);
        ...
        axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("https://api.exchangeratesapi.io/history?start_at=".concat(prevDate, "&end_at=").concat(currDate, "&symbols=").concat(secondCurr, ",").concat(value)).then(function (res) {
          console.log("res ", res);

          _this.setState({
            currencyHistory: res.data
          });
        })["catch"](function (error) {
          console.log(error);
        });
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "secondDD", function (event, _ref2) {
      ...
      if (firstCurr !== '' && {
        ...
        axios__WEBPACK_IMPORTED_MODULE_12___default.a.get("https://api.ratesapi.io/api/latest?symbols=".concat(value, "&base=").concat(firstCurr)).then(function (res) {
          console.log("res ", res);
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "firstValue", function (event) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "secondValue", function (event) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "onExchangeClick", function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Home, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$state4 = this.state,
          totalData = _this$state4.totalData,
          currDate = _this$state4.currDate;
      var options = [];
      var date = new Date();
      currDate = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_0__["default"])("currDate"), date);
      console.log("date ", date);
      date = date.toISOString().split('T')[0];
      console.log("after-date ", date);
      var prevDate = date.setFullYear(date.getFullYear() - 1);
      prevDate = prevDate.toISOString().split('T')[0];
      this.setState({
        currDate: date,
        prevDate: prevDate
      });
      axios__WEBPACK_IMPORTED_MODULE_12___default.a.get('https://restcountries.eu/rest/v2/all').then(function (_ref3) {
        var data = _ref3.data;
    ...
    value: function render() {
      ...
      console.log("home");
      return __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Container"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 146
        },
        __self: this
      }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Segment"].Group, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 147
        },
        ...
        __self: this
      }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Dropdown"], {
        placeholder: "select",
        ...
        __self: this
      }, __jsx(react_icons_fa__WEBPACK_IMPORTED_MODULE_13__["FaExchangeAlt"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(next_router__WEBPACK_IMPORTED_MODULE_9__["withRouter"])(Home));
...
//# sourceMappingURL=index.js.b6eabf2ae34680f492fb.hot-update.js.map