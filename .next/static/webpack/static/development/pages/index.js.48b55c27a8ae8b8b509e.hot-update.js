  ...
  function Home(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "firstDD", function (event, _ref) {
      ...
      if ({
        ...
        axios__WEBPACK_IMPORTED_MODULE_11___default.a.get("https://api.exchangeratesapi.io/latest?symbols=".concat(value, ",").concat(secondCurr)).then(function (_ref2) {
          var res = _ref2.res;
          console.log("res ", res);
        });
      }
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "secondDD", function (event, _ref3) {
      ...
      if (firstCurr !== '' && {
        ...
        axios__WEBPACK_IMPORTED_MODULE_11___default.a.get("https://api.exchangeratesapi.io/latest?symbols=".concat(firstCurr, ",").concat(value)).then(function (_ref4) {
          var res = _ref4.res;
          console.log("res ", res);
        });
      }
...
//# sourceMappingURL=index.js.48b55c27a8ae8b8b509e.hot-update.js.map